    ...
    <div className="p-4 space-y-6 relative">
      {!hasAccess && (
        <div className="absolute inset-0 bg-white/90 backdrop-blur-sm flex flex-col items-center justify-center z-20 rounded-lg p-6 text-center">
            ...
            <p className="text-slate-600 mt-2 mb-6">Upgrade to <strong>Targeted</strong> or <strong>Specialist</strong> tiers to unlock the Clinical Match Probability Engine.</p>
